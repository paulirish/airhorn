...
(function() {
  ...
  var Horn = function() {
    ...
    var audioSrc = '/sounds/djairhornshort.mp3';
    ...
    this.start = function(opts) {
      ...
      loadSound(function(tmpBuffer) {
        ...
        source.loopStart = 1.002;
        source.loopEnd = 1.107;
  ...
  var AirHorn = function(root) {
    ...
    this.start = function(opts) {
      ...
      horn.start(opts);
      if (!!navigator.vibrate) navigator.vibrate(10 * 1000);
    ...
    airhornImage.addEventListener('touchstart', start.bind(this), {passive: false});

    document.documentElement.addEventListener('mouseup', stop.bind(this));
    document.documentElement.addEventListener('touchend', stop.bind(this), {passive: false});
